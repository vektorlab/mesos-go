...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Containers type=*agent.Response_GetContainers_Container kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__Containers = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__Containers == nil {
						tmp_uj__Containers = new(Response_GetContainers_Container)
					}
...
func (mj *Response_GetExecutors) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if len(mj.CompletedExecutors) != 0 {
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Executors type=*agent.Response_GetExecutors_Executor kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__CompletedExecutors type=*agent.Response_GetExecutors_Executor kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__CompletedExecutors = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__CompletedExecutors == nil {
						tmp_uj__CompletedExecutors = new(Response_GetExecutors_Executor)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Frameworks type=*agent.Response_GetFrameworks_Framework kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__CompletedFrameworks type=*agent.Response_GetFrameworks_Framework kind=ptr quoted=false*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__QueuedTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__QueuedTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__QueuedTasks == nil {
						tmp_uj__QueuedTasks = new(mesos.Task)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__LaunchedTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__LaunchedTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__LaunchedTasks == nil {
						tmp_uj__LaunchedTasks = new(mesos.Task)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__TerminatedTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__TerminatedTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__TerminatedTasks == nil {
						tmp_uj__TerminatedTasks = new(mesos.Task)
					}
