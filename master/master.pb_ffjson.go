...
import (
	...
	"github.com/mesos/mesos-go/maintenance"
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Volumes type=*mesos.Resource kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Volumes == nil {
						tmp_uj__Volumes = new(mesos.Resource)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Resources type=*mesos.Resource kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__Resources = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__Resources == nil {
						tmp_uj__Resources = new(mesos.Resource)
					}
...
handle_Duration:
...

	{
		...
		if uj.Duration == nil {
			uj.Duration = new(mesos.DurationInfo)
		}
...
func (mj *Call_SetQuota) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	_ = err
	buf.WriteString(`{ `)
	if mj.QuotaRequest != nil {
		if true {
			/* Struct fall back. type=quota.QuotaRequest kind=struct */
			buf.WriteString(`"quota_request":`)
			err = buf.Encode(mj.QuotaRequest)
			if err != nil {
				return err
			}
			buf.WriteByte(',')
...
handle_QuotaRequest:
	...
	{
		/* Falling back. type=quota.QuotaRequest kind=struct */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}

		err = json.Unmarshal(tbuf, &uj.QuotaRequest)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Machines type=*mesos.MachineID kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__Machines = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__Machines == nil {
						tmp_uj__Machines = new(mesos.MachineID)
					}
...
handle_Schedule:
...

	{
		...
		if uj.Schedule == nil {
			uj.Schedule = new(maintenance.Schedule)
		}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__WeightInfos type=*mesos.WeightInfo kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__WeightInfos = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__WeightInfos == nil {
						tmp_uj__WeightInfos = new(mesos.WeightInfo)
					}
...
handle_Agent:
...

	{
		...
		if uj.Agent == nil {
			uj.Agent = new(Response_GetAgents_Agent)
		}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Agents type=*master.Response_GetAgents_Agent kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Agents == nil {
						tmp_uj__Agents = new(Response_GetAgents_Agent)
					}
...
func (mj *Response_GetAgents_Agent) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if len(mj.AllocatedResources) != 0 {
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__TotalResources type=*mesos.Resource kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__TotalResources = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__TotalResources == nil {
						tmp_uj__TotalResources = new(mesos.Resource)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__AllocatedResources type=*mesos.Resource kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__AllocatedResources = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__AllocatedResources == nil {
						tmp_uj__AllocatedResources = new(mesos.Resource)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__OfferedResources type=*mesos.Resource kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__OfferedResources = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__OfferedResources == nil {
						tmp_uj__OfferedResources = new(mesos.Resource)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Executors type=*master.Response_GetExecutors_Executor kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__Executors = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__Executors == nil {
						tmp_uj__Executors = new(Response_GetExecutors_Executor)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__OrphanExecutors type=*master.Response_GetExecutors_Executor kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__OrphanExecutors = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__OrphanExecutors == nil {
						tmp_uj__OrphanExecutors = new(Response_GetExecutors_Executor)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Flags type=*mesos.Flag kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Flags == nil {
						tmp_uj__Flags = new(mesos.Flag)
					}
...
func (mj *Response_GetFrameworks) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if len(mj.CompletedFrameworks) != 0 {
	...
	if len(mj.RecoveredFrameworks) != 0 {
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Frameworks type=*master.Response_GetFrameworks_Framework kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__Frameworks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__Frameworks == nil {
						tmp_uj__Frameworks = new(Response_GetFrameworks_Framework)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__CompletedFrameworks type=*master.Response_GetFrameworks_Framework kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__CompletedFrameworks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__CompletedFrameworks == nil {
						tmp_uj__CompletedFrameworks = new(Response_GetFrameworks_Framework)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__RecoveredFrameworks type=*mesos.FrameworkInfo kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__RecoveredFrameworks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__RecoveredFrameworks == nil {
						tmp_uj__RecoveredFrameworks = new(mesos.FrameworkInfo)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Offers type=*mesos.Offer kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Offers == nil {
						tmp_uj__Offers = new(mesos.Offer)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__InverseOffers type=*mesos.InverseOffer kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__InverseOffers = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__InverseOffers == nil {
						tmp_uj__InverseOffers = new(mesos.InverseOffer)
					}
...
handle_Status:
...

	{
		...
		if uj.Status == nil {
			uj.Status = new(maintenance.ClusterStatus)
		}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Metrics type=*mesos.Metric kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Metrics == nil {
						tmp_uj__Metrics = new(mesos.Metric)
					}
...
func (mj *Response_GetQuota) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if mj.Status != nil {
		if true {
			/* Struct fall back. type=quota.QuotaStatus kind=struct */
			buf.WriteString(`"status":`)
			err = buf.Encode(mj.Status)
			if err != nil {
				return err
			}
			buf.WriteByte(',')
...
handle_Status:
	...
	{
		/* Falling back. type=quota.QuotaStatus kind=struct */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}

		err = json.Unmarshal(tbuf, &uj.Status)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Roles type=*mesos.Role kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Roles == nil {
						tmp_uj__Roles = new(mesos.Role)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__PendingTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__PendingTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__PendingTasks == nil {
						tmp_uj__PendingTasks = new(mesos.Task)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__Tasks type=*mesos.Task kind=ptr quoted=false*/

				{
					...
					if tmp_uj__Tasks == nil {
						tmp_uj__Tasks = new(mesos.Task)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__CompletedTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__CompletedTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__CompletedTasks == nil {
						tmp_uj__CompletedTasks = new(mesos.Task)
					}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__OrphanTasks type=*mesos.Task kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__OrphanTasks = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__OrphanTasks == nil {
						tmp_uj__OrphanTasks = new(mesos.Task)
					}
...
handle_VersionInfo:
...

	{
		...
		if uj.VersionInfo == nil {
			uj.VersionInfo = new(mesos.VersionInfo)
		}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmp_uj__FileInfos type=*mesos.FileInfo kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {

						tmp_uj__FileInfos = nil

						state = fflib.FFParse_after_value
						goto mainparse
					}

					if tmp_uj__FileInfos == nil {
						tmp_uj__FileInfos = new(mesos.FileInfo)
					}
